...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Namoskar ${pushname} dada 👋. I am ${global.BotName}, a bot modified by: shibam to take your WhatsApp usage into next level.
...
reply(`Send Image/Video With Caption ${prefix + command}\nVideo Duration 1-6 seconds is allowed!`)
}
}
break
